{
  mode: 'production',
  context: '/Users/josesa/Documents/Vue/build-a-bot',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    process: 'mock',
  ...
  output: {
    path: '/Users/josesa/Documents/Vue/build-a-bot/dist',
  ...
  resolve: {
    alias: {
      '@': '/Users/josesa/Documents/Vue/build-a-bot/src',
    ...
    modules: [
      'node_modules',
      '/Users/josesa/Documents/Vue/build-a-bot/node_modules',
      '/Users/josesa/Documents/Vue/build-a-bot/node_modules/@vue/cli-service/node_modules'
    ]
  },
  resolveLoader: {
    modules: [
  ...
  module: {
    ...
    rules: [
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/josesa/Documents/Vue/build-a-bot/node_modules/.cache/vue-loader',
              cacheIdentifier: '4e7ba724'
            }
          },
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: '/Users/josesa/Documents/Vue/build-a-bot/node_modules/mini-css-extract-plugin/dist/loader.js',
                options: {
                  publicPath: '../'
                }
              },
      ...
      /* config.module.rule('js') */
      {
        ...
        use: [
          /* config.module.rule('js').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/josesa/Documents/Vue/build-a-bot/node_modules/.cache/babel-loader',
              cacheIdentifier: '41773d3d'
            }
          },
      ...
      /* config.module.rule('eslint') */
      {
        ...
        exclude: [
          /node_modules/,
          '/Users/josesa/Documents/Vue/build-a-bot/node_modules/@vue/cli-service/lib'
        ],
        use: [
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: '/Users/josesa/Documents/Vue/build-a-bot/public/index.html'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: '/Users/josesa/Documents/Vue/build-a-bot/public',
          to: '/Users/josesa/Documents/Vue/build-a-bot/dist',
          toType: 'dir',
          ignore: [
            'index.html',
            '.DS_Store'
