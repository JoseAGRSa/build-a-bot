<template>
  <div v-if="availableParts" class="content">
    ...
    <div class="bottom-row">
      <PartSelector :parts="availableParts.bases" position="bottom" @partSelected="customMethod"/>
    </div>
  </div>
</template>
...
export default {
  ...
  beforeRouteLeave(to, from, next) {
    if (this.addedToCart) {
      ...
      const response = confirm('You have not added your robot to your carta! Are you sure you want to leave?');
      next(response);
    }
  },
